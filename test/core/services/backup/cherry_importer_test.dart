...
import 'package:Baizi/core/services/backup/cherry_importer.dart';
...
void main() {
  ...
  group('CherryImporter', () {
    test('imports Cherry Studio v6 direct backup zip', () async {
      ...
      await initialPrefs.setStringList('providers_order_v1', ['baizi']);
      ...
      expect(providerConfigs, isNot(contains('sk-test')));
      expect(providerConfigs, isNot(contains('api.example.com')));
      expect(
      ...
      expect(assistant['id'], 'assistant-1');
      expect(assistant['chatModelProvider'], 'baizi');
      expect(assistant['chatModelId'], 'gpt-test');
    });
