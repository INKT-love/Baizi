...
class ChatActionResult {
  ...
  ChatActionResult({required this.success, this.error, this.assistantMessage});
  ...
  factory ChatActionResult.error(Object error) =>
      ChatActionResult(success: false, error: error);

  factory ChatActionResult.noModel() =>
      ChatActionResult(success: false, error: 'no_model');
}
...
class ChatActions {
  ...
  Future<ChatActionResult> sendMessage({
    ...
    try {
      ...
      return ChatActionResult.error(e);
    }
  }
