...
import '../../home/controllers/generation_error_recovery.dart';
...
class _TranslatePageState extends State<TranslatePage> {
  ...
  void _showTranslateError(Object error) {
    final l10n = AppLocalizations.of(context)!;
    ...
    if (recovery == GenerationErrorRecovery.invalidApiKey ||
      ...
      showAppSnackBar(
        context,
        message: recovery == GenerationErrorRecovery.forbiddenApiKey
            ? l10n.baiziForbiddenKey
            : l10n.baiziInvalidKey,
