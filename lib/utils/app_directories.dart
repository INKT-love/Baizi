...
class AppDirectories {
  ...
  /// Gets the directory for imported character card source files.
  static Future<Directory> getCharacterCardsDirectory() async {
    final root = await getAppDataDirectory();
    return Directory('${root.path}/character_cards');
  }
