...
class MessageGenerationService {
  ...
  Future<PreparedGeneration> prepareApiMessagesWithInjections({
    ...
    final kind = settings.providerKindForModel(modelId);
    ...
    messageBuilderService.injectCharacterPostHistoryInstructions(
      apiMessages,
      assistant,
      modelId,
    );
  ...
  bool _shouldIncludeAudioForProvider(
    ...
    if (settings.providerKindForModel(modelId) != ProviderKind.openai) {
      return false;
    }
