...
class ChatboxImporter {
  ...
  // Persisted keys used by AssistantProvider/TagProvider.
  ...
  static Future<ChatboxImportResult> importFromChatbox({
    ...
    // Provider endpoints and credentials are intentionally never imported.
    const importedProviders = 0;
  ...
  _importAssistantsAndConversations(
    ...
    for (final meta in sessionsList) {
      ...
      final assistantJson = <String, dynamic>{
        ...
        'chatModelId': modelId.isEmpty ? null : modelId,
