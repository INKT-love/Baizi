...
class TranslationResult {
  TranslationResult({required this.type, this.error});
...
class TranslationService {
  ...
  Future<TranslationResult> translateMessage({
    ...
    try {
      ...
      // 创建翻译请求
      final provider = settings.baiziProviderConfig;
      ...
      return TranslationResult(type: TranslationResultType.error, error: e);
    }
  }
}
