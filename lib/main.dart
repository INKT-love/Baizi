...
import 'features/setup/widgets/baizi_startup_gate.dart';
...
Future<void> _initDesktopWindow() async {
  ...
  try {
    ...
    await DesktopWindowController.instance.initializeAndShow(title: '白子');
  } catch (_) {
            ...
            builder: (lightDynamic, darkDynamic) {
              ...
              return MaterialApp(
                ...
                onGenerateTitle: (context) =>
                    AppLocalizations.of(context)!.baiziAppName,
...
Widget _selectHome() {
  ...
  final isDesktop =
      ...
      defaultTargetPlatform == TargetPlatform.windows ||
      defaultTargetPlatform == TargetPlatform.linux;
  if (isDesktop) return const DesktopHomePage();
  if (defaultTargetPlatform == TargetPlatform.android) {
    return const BaiziStartupGate(child: HomePage());
  }
