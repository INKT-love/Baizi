import 'dart:convert';
import 'assistant_character_data.dart';
...
class Assistant {
  ...
  // Structured data retained from an imported character card.
  ...
  Assistant copyWith({
    ...
    AssistantCharacterData? characterData,
    ...
    return Assistant(
      ...
      characterData: clearCharacterData
          ? null
  ...
  static Assistant fromJson(Map<String, dynamic> json) => Assistant(
    ...
    characterData: (() {
      final raw = json['characterData'];
      if (raw is! Map) return null;
      return AssistantCharacterData.fromJson(<String, dynamic>{
